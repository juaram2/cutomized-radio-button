...
module.exports = {
  ...
  theme: {
    ...
    colors: {
      inherit: 'inherit',
      current: 'rgb(var(--color-primary) / <alpha-value>)',
      ...
      dark: {
        ...
        70: 'rgb(var(--color-dark-70) / <alpha-value>)',
        90: 'rgb(var(--color-dark-90) / <alpha-value>)',
      },
      light: {
        DEFAULT: 'rgb(var(--color-light) / <alpha-value>)',
        10: 'rgb(var(--color-light-10) / <alpha-value>)',
        30: 'rgb(var(--color-light-30) / <alpha-value>)',
        50: 'rgb(var(--color-light-50) / <alpha-value>)',
        70: 'rgb(var(--color-light-70) / <alpha-value>)',
        90: 'rgb(var(--color-light-90) / <alpha-value>)',
      },
      black: '#000',
      white: '#fff',
      blueGray: {
